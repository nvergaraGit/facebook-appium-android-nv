...
`;
export const ContainerLinkDescription = styled.TouchableOpacity<ThemeProps>``;
...
export const TextSalesFloorLink = styled.Text<ThemeProps>`
  color: ${(props) => props.theme.colors.primaryNav};
  font-family: ${(props) => props.theme.fonts?.mainFont};
`;
